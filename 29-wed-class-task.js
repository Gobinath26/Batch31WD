...
const getCountries = () => {
    ...
    xhr.onload = () => {
        ...
        console.log("Countries Names:",countriesNames);
        //------------------------------------------------------
        ...
        console.log("Population above 1cr countries:",populationabove1crcountries);
        const populationabove1crcountriesNames = populationabove1crcountries.map((country)=>country.name.common);
        console.log("Population above 1cr countries Names:",populationabove1crcountriesNames);
    };
